        ...
        <div className="grid grid-cols-2 w-10/12 py-2 mx-auto  px-2 sm:px-6 lg:px-8">
          <div className="mt-36">
            ...
            <div className=" mt-20 text-xl absolute mb-7">
              <p className="text-blur-200 mb-2" text-xl>Product Supply</p>
          ...
          >
            ...
            <div className="flex">
              ...
              <p className="text-sm text-gray-400">
                i confirm that i have read and agree to the elevate</p>
               <p className="text-xs text-slate-50 text-sm"><spam className="text-sm underline decoration-solid ...">terms&conditions</spam>  <spam className="text-xs text-gray-500">and</spam> <spam className="underline decoration-solid ...">privacy policy.</spam>
              </p>
              </div>
            </div>
