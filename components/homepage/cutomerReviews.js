  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center py-8 pt-20 sm:text-left md:text-left">
        <p className="text-5xl font-gilroybold sm:text-3xl md:text-4xl">See what our customers</p>
        <p className="font-light text-5xl font-gilroylight pb-2 sm:text-3xl md:text-4xl">
          have to say for us
        </p>
