            ...
            <div className="flex-1 flex items-center justify-between">
              ...
              <div className="hidden sm:block sm:ml-6">
                <div className="flex space-x-4">
                  <div className="text-black px-3 py-2 text-lg font-medium" aria-current="page">Solutions</div>
                  <div className="text-black px-3 py-2 text-lg font-medium">Pricing</div>
                  <div className="text-black px-3 py-2 text-lg font-medium">Resources</div>
                  <div className="text-black px-3 py-2 text-lg font-medium">About</div>
                </div>
              </div>
              <div className='flex'>
                <button className="border-2 border-black px-2 mr-3 py-2 text-base font-bold">Sign up</button>
                <button className='bg-black py-2 px-2 text-white text-base font-bold'>Book a demo</button>
              </div>
            </div>
          </div>
        </div>
